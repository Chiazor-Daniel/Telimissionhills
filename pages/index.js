...
const telimissionHillsData = {
  ...
  aboutUs: {
    description:
      'TelimissionHills & Co is a seasoned Law Firm of Legal Practitioners, property consultants and allied services.',
    partners: {
      count: 3,
  ...
  missionStatement: {
    mainGoal:
      'offering excellent legal services while upholding high ethical standards',
    vision:
      'competing favourably and ultimately taking the lead among reputable Law firms both locally and internationally',
    commitment:
      'deliver practical legal solutions with utmost prompt professionalism and expertise',
  },
  ...
  services: [
    {
      ...
      number: '01',
      description:
        'Our expert team handles contracts and debt recovery with unmatched precision and strategic insight.',
    ...
    },
    {
      ...
      number: '02',
      description:
        'We offer effective dispute resolution through skilled arbitration and mediation services.',
      link: '/service-details',
    },
    {
      ...
      number: '03',
      description:
        'Protect your innovations and creative works with our comprehensive intellectual property services.',
      link: '/service-details',
    },
    {
      ...
      number: '04',
      description:
        'Our team expertly navigates maritime regulations and disputes, ensuring favorable outcomes.',
      link: '/service-details',
    },
    {
      ...
      number: '05',
      description:
        'Receive expert advice on property transactions and disputes with our in-depth property law services.',
      link: '/service-details',
    },
    {
      ...
      number: '06',
      description:
        'We provide legal guidance on election-related issues and campaign regulations to ensure compliance.',
      link: '/service-details',
    },
    {
      ...
      number: '07',
      description:
        'Expert handling of divorce and matrimonial disputes with sensitivity and professionalism.',
      link: '/service-details',
    },
    // New Services
    {
      ...
      number: '08',
      description:
        'Specializing in corporate law matters including governance, compliance, and corporate disputes.',
      link: '/service-details',
    },
    {
      icon: <FaHome size={50} className='icon-hover' />,
      ...
      number: '09',
      description:
        'Offering expert advice on property investments, management, and legal issues.',
      link: '/service-details',
    },
    {
      ...
      number: '10',
      description:
        'Providing efficient solutions for recovering outstanding debts through legal channels.',
      link: '/service-details',
    },
    {
      ...
      number: '11',
      description:
        'Handling legal soliciting services for various types of agreements and negotiations.',
      link: '/service-details',
    },
    {
      ...
      number: '12',
      description:
        'Conducting thorough legal research to support your cases and legal matters.',
      link: '/service-details',
    },
    {
      ...
      number: '13',
      description:
        'Offering consulting services for corporate management and operational strategies.',
      link: '/service-details',
    },
    {
      ...
      number: '14',
      description:
        'Expert representation in general commercial and labor law disputes.',
      link: '/service-details',
    },
    {
      icon: <FaBook size={50} className='icon-hover' />,
      ...
      number: '15',
      description:
        'Providing alternative methods for resolving disputes outside of traditional court settings.',
      link: '/service-details',
    },
    {
      icon: <FaFileContract size={50} className='icon-hover' />,
      ...
      number: '16',
      description:
        'Drafting and reviewing MOUs, leases, contracts, agreements, and conveyances with precision.',
      link: '/service-details',
    },
    {
      icon: <FaBook size={50} className='icon-hover' />,
      ...
      number: '17',
      description:
        'Providing reliable legal opinions on complex and straightforward legal issues.',
      link: '/service-details',
    },
  ],
  ...
  const services = [
    {
      ...
      number: '01',
      description:
        'Contracts and debt recovery handled with precision and expertise.',
      link: '/service-details',
    },
    {
      icon: <FaGavel size={50} className='icon-hover' />,
      ...
      number: '02',
      description:
        'Effective dispute resolution through arbitration and mediation.',
      link: '/service-details',
    },
    {
      icon: <FaLightbulb size={50} className='icon-hover' />,
      ...
      number: '03',
      description:
        'Protecting your innovations and creative works with comprehensive IP services.',
      link: '/service-details',
    },
    {
      icon: <FaShip size={50} className='icon-hover' />,
      ...
      number: '04',
      description:
        'Navigating maritime regulations and disputes with expertise.',
      link: '/service-details',
    },
    {
      icon: <FaHome size={50} className='icon-hover' />,
      ...
      number: '05',
      description:
        'Expert advice on private and property-related legal matters.',
      link: '/service-details',
    },
    {
      icon: <FaVoteYea size={50} className='icon-hover' />,
      ...
      number: '06',
      description:
        'Legal guidance on election-related issues and campaign regulations.',
      link: '/service-details',
    },
    {
      icon: <FaHeartBroken size={50} className='icon-hover' />,
      ...
      number: '07',
      description:
        'Handling divorce and matrimonial disputes with sensitivity and expertise.',
      link: '/service-details',
    },
  ];
  const slides = [
            ...
            <div className='col-lg-6'>
              <div className='consen-section-title'>
                ...
                <p className='choose-text1'>
                  At {telimissionHillsData.companyName}, we specialize in
                  delivering tailored legal solutions with unmatched expertise.
                  Our proactive approach ensures efficient handling of your
                  legal matters, providing you with the confidence and support
                  you need.
                </p>
              </div>
